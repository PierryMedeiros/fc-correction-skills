...
Voce cumpriu todos os requisitos do desafio com sucesso: os 4 endpoints estao implementados (POST /products, POST /clients, POST /checkout, GET /invoice/:id), os testes E2E passam, e a estrutura modular do monolito esta correta.
...
Conforme o enunciado, todos os endpoints devem possuir testes E2E com Supertest.

Foram encontrados testes E2E para alguns endpoints, mas nao para todos os 4 exigidos.
