...
Voce cumpriu todos os requisitos do desafio com sucesso: o ProductYupValidator implementa a ValidatorInterface, a entidade Product delega a validacao ao validador sem if/else diretos, e todos os testes passam.
...
A entidade Product ainda contem regras de validacao diretas (if/else).

Conforme o enunciado, a entidade deve delegar a validacao a uma classe validadora especializada (ProductYupValidator).
