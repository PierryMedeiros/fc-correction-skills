# Guia de Devolutivas - Codeflix Python PATCH API Categoria
...
Voce cumpriu todos os requisitos do desafio com sucesso: o metodo partial_update esta implementado, o serializer usa partial=True, e os testes validam a atualizacao parcial isolada de cada campo.
...
Faltam testes de atualizacao parcial isolada para cada campo.

Conforme o enunciado, deve haver testes que enviem apenas name, apenas description, e apenas is_active, verificando que os campos nao enviados permaneceram inalterados.
