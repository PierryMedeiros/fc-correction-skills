...
Voce cumpriu todos os requisitos do desafio com sucesso: a aplicacao Go imprime 'Full Cycle Rocks!!', o Dockerfile utiliza multi-stage build com imagem final minima, e a imagem resultante tem menos de 2MB.
