# Guia de Devolutivas - Codeflix Py Update API Genre (PUT)
...
Voce cumpriu todos os requisitos: endpoint PUT implementado com substituicao total, e os 4 cenarios de teste cobertos.
...
Ola, {Nome}!
Parabens pelo bom trabalho!
Excelente trabalho! O PUT substitui completamente os dados do genero, incluindo categorias vinculadas, e os 4 testes passam.
Continue com esse ritmo de dedicacao, seu progresso esta nitido!
Bons estudos e ate o proximo desafio!
Abraco!
### Exemplo 3
Ola, {Nome}!
Parabens pelo bom trabalho!
Todos os requisitos atendidos. Dados validos retornam 200, dados invalidos 400, categorias inexistentes 400, e genre inexistente 404.
Continue com esse ritmo de dedicacao, seu progresso esta nitido!
Bons estudos e ate o proximo desafio!
Abraco!
---
...
Faltam cenarios de teste. O teste test_when_related_categories_do_not_exist_then_return_400 nao foi encontrado.
Os 4 cenarios obrigatorios sao: dados validos, dados invalidos (400), categorias inexistentes (400), genre inexistente (404).
Reveja esse ponto e, quando finalizar, envie o projeto novamente para correcao.
Bom trabalho!
### Exemplo 2
Ola, {Nome}!
Obrigado por enviar a sua resposta ao exercicio!
O endpoint PUT nao implementa substituicao total. As categorias antigas nao sao removidas ao atualizar.
O PUT deve substituir completamente: se um genero tinha 3 categorias e a atualizacao passa 2, deve ficar com apenas 2.
Reveja esse ponto e, quando finalizar, envie o projeto novamente para correcao.
Bom trabalho!
### Exemplo 3
Ola, {Nome}!
Obrigado por enviar a sua resposta ao exercicio!
O metodo update nao esta implementado na view de Genre.
Adicione o metodo update no views.py do genre_app com a assinatura def update(self, request, pk=None).
Reveja esse ponto e, quando finalizar, envie o projeto novamente para correcao.
Bom trabalho!
