...
Voce cumpriu todos os requisitos do desafio com sucesso: o commit esta assinado com GPG, a badge 'Verified' esta visivel no GitHub, e o README esta presente.
...
O commit nao esta assinado (badge 'Verified' nao encontrada no GitHub).

Configure uma chave GPG, vincule-a ao GitHub, e faca um novo commit assinado.
