# Guia de Devolutivas - Git Commit Assinado
...
Voce cumpriu todos os requisitos: o commit esta assinado com GPG, a badge 'Verified' esta visivel no GitHub, e o README esta presente.
...
Ola, {Nome}!
Parabens pelo bom trabalho!
Excelente trabalho! A badge verde 'Verified' aparece no historico de commits, demonstrando que a chave GPG esta configurada e vinculada corretamente.
Continue com esse ritmo de dedicacao, seu progresso esta nitido!
Bons estudos e ate o proximo desafio!
Abraco!
### Exemplo 3
Ola, {Nome}!
Parabens pelo bom trabalho!
Todos os requisitos atendidos. O commit esta assinado (verified: true), o repositorio e publico, e o README descreve o desafio.
Continue com esse ritmo de dedicacao, seu progresso esta nitido!
Bons estudos e ate o proximo desafio!
Abraco!
---
...
O commit nao esta assinado. A badge 'Verified' nao foi encontrada no GitHub (campo verified: false).
Configure uma chave GPG em sua maquina, vincule-a ao GitHub, e faca um novo commit assinado com git commit -S.
Reveja esse ponto e, quando finalizar, envie o projeto novamente para correcao.
Bom trabalho!
### Exemplo 2
Ola, {Nome}!
Obrigado por enviar a sua resposta ao exercicio!
O repositorio nao contem um arquivo README.md.
Conforme o enunciado, o repositorio deve conter um README.md (pode ser simples, apenas descrevendo o desafio).
Reveja esse ponto e, quando finalizar, envie o projeto novamente para correcao.
Bom trabalho!
### Exemplo 3
Ola, {Nome}!
