...
Voce cumpriu todos os requisitos do desafio com sucesso: a classe OrderRepository implementa os 4 metodos (create, update, find, findAll), os testes cobrem todos os cenarios, e a estrutura segue o padrao do curso.
...
A classe OrderRepository nao implementa todos os metodos exigidos.

Conforme o enunciado, os metodos create, update, find e findAll devem estar implementados e testados.
