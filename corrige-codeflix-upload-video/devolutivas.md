# Guia de Devolutivas - Codeflix Upload Video
...
Voce cumpriu todos os requisitos do desafio com sucesso: o campo video_file esta na migration como string e nullable, a validacao exige tipo video/mp4 e tamanho maximo, o upload via POST funciona, e os testes validam o fluxo.
...
Conforme o enunciado, deve haver testes que validem a rejeicao de tipos diferentes de video/mp4 e arquivos que excedam o tamanho maximo.
